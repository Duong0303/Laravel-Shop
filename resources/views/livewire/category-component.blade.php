                                ...
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            {{-- <li><a href="#" wire:click.prevent="changePageSize(All)">All</a></li> --}}
                                        </ul>
                                    </div>
                                </div>
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy=='Release Date' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Sort By Newness')">Sort By Newness</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
